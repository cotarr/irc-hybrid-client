...
write and closing the file causing file corruption.
When the irc-hybrid-client is subsequently restarted,
the zero length file caused a fatal JSON decoding error
causing irc-hybrid-client to exit.
With this patch, if the IRC message cache does not exist
or has zero length, irc-hybrid-client will start normally
with a freshly initialized empty message cache.
...
## [v2.1.11](https://github.com/cotarr/irc-hybrid-client/releases/tag/v2.1.11) 2026-03-16

- Update outdated npm dependencies to clear npm audit warning

## [v2.1.10](https://github.com/cotarr/irc-hybrid-client/releases/tag/v2.1.10) 2026-03-08

- Bump express-rate-limit and minimatch to clear npm audit warning.

## [v2.1.9](https://github.com/cotarr/irc-hybrid-client/releases/tag/v2.1.9) 2026-02-21
...
- Added new hot-key Alt-. (Alt + Period) to show/hide the debug panel.
...
- In server/middlewares/remote-authenticate.mjs, removed import of npm module 'node-fetch' which was only required for NodeJs v18 and below. This was a work around that is no longer required for the current floor of NodeJs >=20. The alternate fetch function was only imported when not available in NodeJs as an internal native module. This clears a deprecation warning displayed on new installs.
...
## [v2.1.5](https://github.com/cotarr/irc-hybrid-client/releases/tag/v2.1.5) 2025-12-02
...
- Updated all npm modules to current, delete /node_modules/ and package-lock.json to clear npm audit warning
...
The legacy ThunderClient collections (vscode extension) can be found in the
 "thunderclient/" folder in commit 4521f164eb84767447eaa5566b8ca6209f53b966 for version v2.0.23 from 2025-01-22.

### Changes

- There are no code changes in v2.0.24.

- Added "debug" to the .gitignore to avoid committing the debug test script symbolic link into the repository.
- The Thunder Client tests in the /thunderclient/ folder have been deleted.
- Updated the /docs/ folder web page help files to describe the new API testing utilities.

## [v2.0.23](https://github.com/cotarr/irc-hybrid-client/releases/tag/v2.0.23) 2025-01-22
...
Although div elements work well with mouse clicks and phone taps, 
this approach impedes effective use of keyboard navigation.
The first step will be to identify frequently used controls
and convert them from div elements to styled button elements.
